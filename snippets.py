...
def snippet_4():
    ...
    # single = assigns a variable. double == means it is equal to, d equals false. 
    # = is an assignment operator and == is a comparison operator. We are using assert
    # to check and make sure that d is really False. We would get a Traceback Assertion Error if d was
    # true. Running assert(d == False) will give us an empty prompt because the statement is true.
